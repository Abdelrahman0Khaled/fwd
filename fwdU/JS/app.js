...
const scrollBtn = document.getElementsByClassName("top-puton")[0];
...
const showBackToTop = () =>	window.addEventListener("scroll", () => scrollBtn.classList.toggle("top-puton-act", window.scrollY > 600));
